...
const generateProducts = (users, categories) => [
  // Electronics
  {
    ...
    seller: users.find((u) => u.sellerInfo?.businessName === "TechGear Hub")
      ._id,
    tags: [
      "wireless",
      "bluetooth",
  ...
  },
  {
    ...
    description:
      "Authentic vintage-style leather jacket, handcrafted with premium materials. Each piece is unique.",
    ...
    seller: users.find(
      (u) => u.sellerInfo?.businessName === "Jane's Fashion Store"
    )._id,
    tags: [
      "vintage",
      "handmade",
    ...
    images: [
      {
        url: "jacket-1.jpg",
        alt: "Vintage leather jacket front",
        isPrimary: true,
      },
  ...
  },
  {
    ...
    description:
      "High-performance running shoes designed for professional athletes and fitness enthusiasts.",
  ...
  },
  {
    ...
    description:
      "WiFi-enabled smart LED bulbs that can be controlled via smartphone app. Energy efficient and customizable.",
  ...
  },
  {
    ...
    description:
      "Rare first edition programming guide signed by the author. Perfect for collectors and developers.",
  ...
  },
  {
    ...
    description:
      "Comfortable cotton t-shirt perfect for everyday wear. Soft fabric and relaxed fit.",
  ...
  },
  {
    ...
    description:
      "Premium yoga mat with alignment lines to help perfect your poses. Non-slip surface and eco-friendly materials.",
    ...
    images: [
      {
        url: "yogamat-1.jpg",
        alt: "Yoga mat with alignment lines",
        isPrimary: true,
      },
  ...
  try {
    ...
    console.log(
      `👥 Users: ${createdUsers.length} (${
        createdUsers.filter((u) => u.role === "buyer").length
      } buyers, ${
        createdUsers.filter((u) => u.role === "seller").length
      } sellers, ${
    ...
    console.log(
      `📦 Products: ${createdProducts.length} (${
        createdProducts.filter((p) => p.isUnique).length
      } unique products)`
    );
